...
def main():
    ...
    # Per-script output sidecar so the workflow can process multiple
    # kernels without GITHUB_OUTPUT key collisions.
    out = {
        "status": status,
        "kernel_id": "cachyos",
        "component_path": "components/kernel/cachyos-kernel",
