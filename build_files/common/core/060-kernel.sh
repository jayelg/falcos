### CachyOS kernel
# Replaces the stock Fedora kernel. Runs early so everything downstream
# (dracut regen, DKMS builds, firmware) targets the final kernel.
...
# Needed for signing now, before phase-finalize.sh copies files/common
